...
CREATE TABLE `cm_config` (
  ...
  `shop_template_id` varchar(255) NOT NULL default '',
  ...
  `deepl_api_use` tinyint(4) NOT NULL default '0',
...
INSERT INTO `cm_config` (`id`, `admin_id`, `cf_original_lang`, `site_title`, `admin_email`, `contact_number`, `add_meta`, `template_id`, `shop_template_id`, `ip_access`, `ip_block`, `recaptcha_site_key`, `recaptcha_secret_key`, `google_map_iframe_src`, `deepl_api_use`, `deepl_api_key`, `deepl_api_plan`, `pwa_use`, `pwa_vapid_public_key`, `pwa_vapid_private_key`, `business_reg_no`, `online_sales_no`, `representative_name`, `privacy_manager`, `business_address`, `business_type`, `business_category`, `operating_hours`, `bank_name`, `account_holder`, `account_number`, `updated_at`) VALUES
