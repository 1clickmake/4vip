        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="get" class="row g-3"  id="searchForm" onsubmit="return validateSearch()">
                    ...
                    <div class="col-md-3">
                        <select name="search_field" class="form-select" required>
                    ...
                    <div class="col-md-7">
                        <input type="text" name="search_keyword" class="form-control" value="<?php echo htmlspecialchars($_GET['search_keyword'] ?? '');?>" placeholder="검색어를 입력하세요" required>
                    </div>
