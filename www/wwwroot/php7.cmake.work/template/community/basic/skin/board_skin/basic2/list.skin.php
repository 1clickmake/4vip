...
<main class="main-content">
        <!-- Page Header -->
		<div class="rounded bg-white mb-2 px-3 py-1 shadow-sm">
			<div class="page-header">
				<h1 class="page-title"><i class="bi bi-card-list"></i> <?php echo $cm_title;?></h1>
			</div>
			<!-- Board Controls -->
			<div class="board-controls">
				...
				<div class="board-actions">
					<form method="get" class="search-form" onsubmit="return validateSearch()">
						...
						<button type="submit" class="btn btn-light btn-outline">검색</button>
						<?php if ($has_search): ?>
        ...
        <div class="board-table">
            <table class="table">
                <thead class="text-center">
                    <tr>
                        <?php if($is_admin){?><th width="50"><input type="checkbox" id="selectAllPosts" onclick="toggleAllCheckBoxes(this);" title="전체 선택/해제"></th><?php } ?>
                        <th width="80">번호</th>
                        <th class="text-center">제목</th>
                        <th width="120" class="hide-mobile">작성자</th>
                        <th width="120" class="hide-mobile">작성일</th>
                        <th width="80" class="hide-mobile">조회</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php else: ?>
						...
						<tr class="table-light">
                            ...
                            <td class="text-center"><?= htmlspecialchars($notice['name']) ?></td>
                            <td class="text-center"><?= date('Y-m-d', strtotime($notice['reg_date'])) ?></td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo get_board_url('view', $boardId, $list['board_num']);?>" class="text-decoration-none">
                                    ...
                                    <i class="fa-solid fa-paperclip ms-1" title=""></i>
                                    <?php } ?>
									<?php if($list['secret_chk'] == 1){?>
									<i class="bi bi-lock-fill ms-1" title="비밀글"></i>
									<?php } ?>
                                </a>
                            </td>
